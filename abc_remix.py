...
from models.abc.abc_remix import Abc
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='abc')
    ...
    # config file
    parser.add_argument('--c', type=str, default='./config/abc/abc_cifar10.yaml')
