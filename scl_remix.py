...
from models.scl.scl_remix import Scl
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='scl')
    ...
    # config file
    parser.add_argument('--c', type=str, default='./config/scl/scl_cifar10.yaml')
