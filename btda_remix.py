...
from models.btda.btda2_remix import Linear  #BTDA(Gassion)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='linear')
    ...
    # config file
    parser.add_argument('--c', type=str, default='./config/linear/linear_cifar10_4000_0.yaml')
