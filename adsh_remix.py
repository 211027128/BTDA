...
#from models.btda.btda_remix import Linear #BTDA(DA)
from models.adsh.adsh_remix import Adsh
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    loader_dict = {}
    dset_dict = {'train_lb': lb_dset, 'train_ulb': ulb_dset,'train_adsh': ulb_dset, 'eval': eval_dset}
    ...
    loader_dict['train_ulb'] = get_data_loader(dset_dict['train_ulb'],
                                               ...
                                               distributed=args.distributed)
    loader_dict['train_adsh'] = get_data_loader(dset_dict['train_adsh'],
                                               args.batch_size * args.uratio,
                                               data_sampler=args.train_sampler,
                                               num_workers=4 * args.num_workers,
                                               distributed=args.distributed)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_name', type=str, default='adsh')
    ...
    # config file
    parser.add_argument('--c', type=str, default='./config/adsh/adsh_cifar10.yaml')
